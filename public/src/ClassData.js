...
var ReferenceClassData = (function (_super) {
    ...
    ReferenceClassData.prototype._constructConstructor = function (thread) {
        ...
        return eval(evalText)(extendClass, this, threading_1.InternalStackFrame, threading_1.NativeStackFrame, threading_1.BytecodeStackFrame, gLong.ZERO, require('./ClassLoader'), require('./Monitor'), thread);
    };
